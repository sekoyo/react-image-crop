...
function withCrop(BaseComponent) {
  class ReactCropHoc extends Component {
    ...
    constructor(props) {
      ...
      this.nextCropState = this.nextCropState.bind(this);
      this.crossOverCheck = this.crossOverCheck.bind(this);
      this.getCropStyle = this.getCropStyle.bind(this);
    ...
    render() {
      return (<BaseComponent
        nextCropState={this.nextCropState}
        crossOverCheck={this.crossOverCheck}
        onDocMouseTouchMove={this.onDocMouseTouchMove}
        onImageLoad={this.onImageLoad}
        onComponentMouseTouchDown={this.onComponentMouseTouchDown}
        onComponentKeyDown={this.onComponentKeyDown}
        onCropMouseTouchDown={this.onCropMouseTouchDown}
        getCropStyle={this.getCropStyle}
        cropSelectRef={(cropSelectElement) => { this.cropSelectRef = cropSelectElement; }}

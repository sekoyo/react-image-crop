...
class ReactCrop extends Component {
	...
	componentDidMount() {
		...
		// The image may have already been loaded. 
		// In this case, the onLoad event is not fired.
	...
	render() {
		...
		return (
			<div ref="component"
				...
				<img ref='image' crossOrigin="anonymous" className='ReactCrop--image' src={this.props.src} onLoad={(e) => { this.onImageLoad(e.target); }} />
